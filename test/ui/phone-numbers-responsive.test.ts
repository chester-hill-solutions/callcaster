...
// Regression test for audit-F's P1 "phone-numbers unusable on mobile"
...
describe("app/routes/workspaces+/$id/phone-numbers.route.tsx responsive layout", () => {
  const source = readFileSync(
    path.resolve(
      __dirname,
       "../../app/routes/workspaces+/$id/phone-numbers.route.tsx",
    ),
    "utf-8",
  );
