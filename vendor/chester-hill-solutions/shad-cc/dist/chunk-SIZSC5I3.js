...
function Card({
  ...
  return /* @__PURE__ */ jsx(
    "div",
    {
      ...
      "data-size": size,
      className: cn(
        "group/card flex flex-col gap-(--card-spacing) overflow-hidden rounded-lg border border-border bg-card py-(--card-spacing) text-sm text-card-foreground shadow-[0_2px_0_0_var(--border)] [--card-spacing:--spacing(6)] has-[>img:first-child]:pt-0 data-[size=sm]:[--card-spacing:--spacing(4)] *:[img:first-child]:rounded-t-lg *:[img:last-child]:rounded-b-lg",
        className
      ),
      ...props
    }
...
//# sourceMappingURL=chunk-SIZSC5I3.js.map
//# sourceMappingURL=chunk-SIZSC5I3.js.map