  ...
  "group/alert relative grid w-full gap-0.5 rounded-md border px-4 py-3 text-left text-sm has-data-[slot=alert-action]:relative has-data-[slot=alert-action]:pr-18 has-[>svg]:grid-cols-[auto_1fr] has-[>svg]:gap-x-2.5 *:[svg]:row-span-2 *:[svg]:translate-y-0.5 *:[svg]:text-current *:[svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        ...
        destructive: "border-destructive/40 bg-destructive/12 text-destructive *:data-[slot=alert-description]:text-destructive/90 *:[svg]:text-current",
        success: "border-success/40 bg-success/12 text-success *:data-[slot=alert-description]:text-success/90 *:[svg]:text-current",
        warning: "border-warning/45 bg-warning/15 text-warning-foreground *:data-[slot=alert-description]:text-warning-foreground/90 *:[svg]:text-current",
...
//# sourceMappingURL=chunk-MEVOKXA6.js.map
//# sourceMappingURL=chunk-MEVOKXA6.js.map