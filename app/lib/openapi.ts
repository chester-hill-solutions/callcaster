/**
 * OpenAPI 3.0 spec for CallCaster public integrator API.
 * Served at /api/docs/openapi for Scalar and external tools.
 */
import { PUBLIC_API_TAG } from "@/lib/public-api";
...
export const openApiSpec = {
  ...
  tags: [
    {
      name: PUBLIC_API_TAG,
      description: "Integrator-facing JSON APIs (documented for external use).",
    },
          ...
          content: {
            "application/json": {
              ...
              examples: {
                ...
                existingScript: {
                  summary: "Existing script (API key)",
                  value: {
