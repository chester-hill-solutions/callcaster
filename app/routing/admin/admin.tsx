...
export const loader = async ({ request }: LoaderFunctionArgs) => {
    ...
    const { deriveWorkspaceAdminRows } = await import("@/lib/admin-workspaces.server");
    const workspaceAdminRows = deriveWorkspaceAdminRows({
...
export default function Admin() {
    const { user, workspaces, users, workspaceUsers, workspaceNumbers, campaigns, stats, workspaceAdminRows } = useLoaderData<typeof loader>();
    ...
    const workspaceRows = workspaceAdminRows;
