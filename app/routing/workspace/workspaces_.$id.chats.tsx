...
export async function action({ request, params }: ActionFunctionArgs) {
  ...
  const { sendMessage } = await import("@/lib/api-chat-sms.server");
...
export default function ChatsList() {
  ...
  return (
    <main className="flex h-[calc(100vh-184px)] w-full flex-col gap-4 md:flex-row">
      <Card className="flex h-[68vh] max-h-[68vh] hidden flex-col overflow-hidden border-border/80 md:flex md:max-w-[40%] md:basis-2/5">
        <ConversationSidebar
          campaigns={campaigns}
