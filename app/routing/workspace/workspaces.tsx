  ...
  ({ workspace, role }: { workspace: Workspace; role: MemberRole }) => {
    return (
      <NavLink
        ...
        className="flex h-full flex-col items-center justify-center rounded-lg border border-border/80 bg-brand-secondary p-4 text-center text-card-foreground shadow-sm transition-colors duration-150 hover:bg-accent hover:text-accent-foreground dark:border-white/20 dark:hover:bg-zinc-800"
      >
...
export default function Workspaces() {
  ...
  return (
    <main className="mx-auto flex h-full w-full max-w-7xl flex-col items-center gap-8 px-4 py-8">
      ...
      <Section className="w-full rounded-lg border border-border/80">
        <SectionHeader
          branded
