...
export const loader = async ({
  ...
  const { logger: serverLogger } = await import("@/lib/logger.server");
  ...
  try {
    ...
    serverLogger.error("Error in contact loader:", error);
    return redirect(`/workspaces/${workspace_id}`);
  }
};
...
export const action = async ({
  ...
  try {
    ...
    serverLogger.error("Error in contact action:", error);
