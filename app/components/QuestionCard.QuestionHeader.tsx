import { VoxTypeSelector } from "@/components/campaign/settings/VoxTypeSelector";
...
interface QuestionHeaderProps {
  ...
  onSpeechTypeChange: (value: "recorded" | "synthetic") => void;
}

export const QuestionHeader = ({ question, edit, onNameChange, onSpeechTypeChange }: QuestionHeaderProps) => {
    return (
