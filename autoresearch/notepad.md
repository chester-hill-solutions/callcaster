...
- 2026-08-26 | bundle | Client JS total: 5.32MB (450 files). Main chunk: 2.77MB (52%). Key non-route chunks: entry.client 208KB, twilio 176KB, AgentScalarChatInterface.vue 138KB, manifest 141KB, utils 90KB, wavesurfer 41KB. 3× TabacSlab OTF fonts 522KB total (CSS assets, not JS). rollup-plugin-visualizer stats mix server+client (single chunk); use autoresearch/analyze-bundle.mjs for client-only file sizes. | evidence: autoresearch/analyze-bundle.mjs, build/client/assets/ | confidence: certain
