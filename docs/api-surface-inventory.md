...
| `/api/workspace-api-keys` | POST, DELETE, GET | Workspace Admin | sessionOnly | yes | `routes/api+/workspace-api-keys.tsx` | `docs/api-workspace-admin.md` |  |
...
| `/api/workspaces/:workspaceId/api-keys` | POST, DELETE, GET | Workspace Admin | sessionOnly | yes | `routes/api+/workspaces+/$workspaceId/api-keys.route.tsx` | `docs/api-workspace-admin.md` |  |
