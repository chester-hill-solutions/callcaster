...
- E3.2: `design-preview-a11y.spec.ts` opens all four toast tones, focuses, selects, and renders disabled, invalid, and loading controls before scanning, asserts the root theme, and proves the contrast rule ran.
