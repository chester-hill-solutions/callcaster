...
- Campaign schedule sync keeps a newer pause or completion status when it races with a stale sweep ([#1794](https://github.com/chester-hill-solutions/callcaster/issues/1794)).
