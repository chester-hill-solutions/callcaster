...
| 2 — Drizzle port | **In progress** | 7/13 modules; 127 dial/messaging tests; ~40+ PostgREST sites |
...
| **WS-B** | 2 | `app/lib/database/*` → `createTenantDb`; platform-data next | Active — baseline unblocks port |
