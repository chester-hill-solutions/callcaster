...
`Effort` is not an issue label in this repository. It is a custom field on CHS Backlog Project `9`; load `github-projects` and inspect that Project item before selecting issues by effort.
